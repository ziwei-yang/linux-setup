...
for pylib in pycurl simplejson chardet lxml numpy scipy scikit-learn matplotlib jieba redis pika pyquery request thrift cssselect xlrd MySQL-python readability-lxml; do
