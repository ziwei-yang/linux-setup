...
if [[ $os == CentOS* ]]; then
	sudo yum -y install httpd php php-mysql libxml2-devel libxml2 ImageMagick ImageMagick-devel libpng-devel libcurl libcurl-devel gd gd-devel php-gd php5-dom
elif [[ $os == Ubuntu* ]]; then
